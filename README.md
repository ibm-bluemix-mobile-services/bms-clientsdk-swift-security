...
```Swift
initializeWithBluemixAppRoute: bluemixAppGUID: bluemixRegionSuffix:
```
method before any other API calls. BMSClient provides information about the current SDK level and access to service SDKs. This method is usually in the application delegate of your mobile app.
